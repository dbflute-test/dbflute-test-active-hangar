package org.docksidestage.hangar.dbflute.whitebox.allcommon;
...
public class WxCDefTest extends PlainTestCase {
    ...
    public void test_sisterSet() throws Exception {
        ...
        assertEquals(newHashSet("Formalized"), CDef.MemberStatus.Formalized.sisterSet());
    }
    ...
    public void test_inGroup_direct() {
        ...
        assertTrue(CDef.MemberStatus.Formalized.inGroup("ServiceAvailable")); // case insensitive since 1.2.6
    ...
    public void test_meta_of() {
        ...
        assertEquals(CDef.MemberStatus.Formalized, CDef.DefMeta.MemberStatus.of("Formalized").get());
    }
    ...
    public void test_meta_codeOf() { // old style
        ...
        assertNotNull(CDef.DefMeta.MemberStatus.codeOf("Formalized"));
    }
    ...
    public void test_meta_undefinedHandlingType() {
        // undefinedHandlingType=EXCEPTION is set
        //assertEquals(ClassificationUndefinedHandlingType.LOGGING, CDef.DefMeta.MemberStatus.undefinedHandlingType());
        assertEquals(ClassificationUndefinedHandlingType.EXCEPTION, CDef.DefMeta.MemberStatus.undefinedHandlingType());
