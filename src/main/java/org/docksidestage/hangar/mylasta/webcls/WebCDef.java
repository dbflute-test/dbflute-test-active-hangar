...
public interface WebCDef extends Classification {
     ...
     */
    public enum AppSea implements WebCDef {
        ...
        public ClassificationMeta meta() { return WebCDef.DefMeta.AppSea; }
     ...
     */
    public enum AppLand implements WebCDef {
        /** ShowBase: Formalized */
        ...
        public ClassificationMeta meta() { return WebCDef.DefMeta.AppLand; }
     ...
     */
    public enum AppPiari implements WebCDef {
        /** ShowBase: Formalized */
        OneMan("FML", "ShowBase", emptyStrings())
        ,
        /** Castle: Provisional */
        ...
        public Set<String> sisterSet() { return _sisterSet; }
        public Map<String, Object> subItemMap() { return Collections.emptyMap(); }
        public ClassificationMeta meta() { return WebCDef.DefMeta.AppPiari; }
     ...
     */
    public enum AppBonvo implements WebCDef {
        /** Formalized: as formal member, allowed to use all service */
        Formalized("FML", "Formalized", new String[] {"Formalized"})
        ,
        /** Withdrawal: withdrawal is fixed, not allowed to use service */
        ...
        public Set<String> sisterSet() { return _sisterSet; }
        public Map<String, Object> subItemMap() { return _subItemMapMap.get(code()); }
        public ClassificationMeta meta() { return WebCDef.DefMeta.AppBonvo; }
     ...
     */
    public enum AppDstore implements WebCDef {
        /** ShowBase: Formalized */
        OneMan("FML", "ShowBase", emptyStrings())
        ,
        /** Orlean: Withdrawal */
        ...
        public Set<String> sisterSet() { return _sisterSet; }
        public Map<String, Object> subItemMap() { return Collections.emptyMap(); }
        public ClassificationMeta meta() { return WebCDef.DefMeta.AppDstore; }
     ...
     */
    public enum AppAmba implements WebCDef {
        /** Formalized: as formal member, allowed to use all service */
        Formalized("FML", "Formalized", new String[] {"Formalized"})
        ,
        /** Withdrawal: withdrawal is fixed, not allowed to use service */
        ...
        public Set<String> sisterSet() { return _sisterSet; }
        public Map<String, Object> subItemMap() { return _subItemMapMap.get(code()); }
        public ClassificationMeta meta() { return WebCDef.DefMeta.AppAmba; }
     ...
     */
    public enum AppMiraco implements WebCDef {
        /** ShowBase: Formalized */
        ...
        public Set<String> sisterSet() { return _sisterSet; }
        public Map<String, Object> subItemMap() { return _subItemMapMap.get(code()); }
        public ClassificationMeta meta() { return WebCDef.DefMeta.AppMiraco; }
     ...
     */
    public enum AppDohotel implements WebCDef {
        /** Formalized: as formal member, allowed to use all service */
        Formalized("FML", "Formalized", new String[] {"Formalized"})
        ,
        /** Provisional: first status after entry, allowed to use only part of service */
        ...
        public Set<String> sisterSet() { return _sisterSet; }
        public Map<String, Object> subItemMap() { return _subItemMapMap.get(code()); }
        public ClassificationMeta meta() { return WebCDef.DefMeta.AppDohotel; }
     ...
     */
    public enum AppFlg implements WebCDef {
        /** Yes: means valid */
        ...
        public Set<String> sisterSet() { return _sisterSet; }
        public Map<String, Object> subItemMap() { return _subItemMapMap.get(code()); }
        public ClassificationMeta meta() { return WebCDef.DefMeta.AppFlg; }
     ...
     */
    public enum AppPaymentMethod implements WebCDef {
        ...
        public Set<String> sisterSet() { return _sisterSet; }
        public Map<String, Object> subItemMap() { return Collections.emptyMap(); }
        public ClassificationMeta meta() { return WebCDef.DefMeta.AppPaymentMethod; }
    ...
    public enum DefMeta implements ClassificationMeta {
        ...
        public OptionalThing<? extends Classification> of(Object code) {
            if (AppSea.name().equals(name())) { return WebCDef.AppSea.of(code); }
            if (AppLand.name().equals(name())) { return WebCDef.AppLand.of(code); }
            if (AppPiari.name().equals(name())) { return WebCDef.AppPiari.of(code); }
            if (AppBonvo.name().equals(name())) { return WebCDef.AppBonvo.of(code); }
            if (AppDstore.name().equals(name())) { return WebCDef.AppDstore.of(code); }
            if (AppAmba.name().equals(name())) { return WebCDef.AppAmba.of(code); }
            if (AppMiraco.name().equals(name())) { return WebCDef.AppMiraco.of(code); }
            if (AppDohotel.name().equals(name())) { return WebCDef.AppDohotel.of(code); }
            if (AppFlg.name().equals(name())) { return WebCDef.AppFlg.of(code); }
            if (AppPaymentMethod.name().equals(name())) { return WebCDef.AppPaymentMethod.of(code); }
            if (DeepWxLiteralGrouping.name().equals(name())) { return WebCDef.DeepWxLiteralGrouping.of(code); }
            if (DeepWxDeprecatedCls.name().equals(name())) { return WebCDef.DeepWxDeprecatedCls.of(code); }
            if (DeepWxDeprecatedElement.name().equals(name())) { return WebCDef.DeepWxDeprecatedElement.of(code); }
            throw new IllegalStateException("Unknown definition: " + this); // basically unreachable
        }

        public OptionalThing<? extends Classification> byName(String name) {
            if (AppSea.name().equals(name())) { return WebCDef.AppSea.byName(name); }
            if (AppLand.name().equals(name())) { return WebCDef.AppLand.byName(name); }
            if (AppPiari.name().equals(name())) { return WebCDef.AppPiari.byName(name); }
            if (AppBonvo.name().equals(name())) { return WebCDef.AppBonvo.byName(name); }
            if (AppDstore.name().equals(name())) { return WebCDef.AppDstore.byName(name); }
            if (AppAmba.name().equals(name())) { return WebCDef.AppAmba.byName(name); }
            if (AppMiraco.name().equals(name())) { return WebCDef.AppMiraco.byName(name); }
            if (AppDohotel.name().equals(name())) { return WebCDef.AppDohotel.byName(name); }
            if (AppFlg.name().equals(name())) { return WebCDef.AppFlg.byName(name); }
            if (AppPaymentMethod.name().equals(name())) { return WebCDef.AppPaymentMethod.byName(name); }
            if (DeepWxLiteralGrouping.name().equals(name())) { return WebCDef.DeepWxLiteralGrouping.byName(name); }
            if (DeepWxDeprecatedCls.name().equals(name())) { return WebCDef.DeepWxDeprecatedCls.byName(name); }
            if (DeepWxDeprecatedElement.name().equals(name())) { return WebCDef.DeepWxDeprecatedElement.byName(name); }
            throw new IllegalStateException("Unknown definition: " + this); // basically unreachable
        }

        public Classification codeOf(Object code) { // null if not found, old style so use of(code)
            if (AppSea.name().equals(name())) { return WebCDef.AppSea.codeOf(code); }
            if (AppLand.name().equals(name())) { return WebCDef.AppLand.codeOf(code); }
            if (AppPiari.name().equals(name())) { return WebCDef.AppPiari.codeOf(code); }
            if (AppBonvo.name().equals(name())) { return WebCDef.AppBonvo.codeOf(code); }
            if (AppDstore.name().equals(name())) { return WebCDef.AppDstore.codeOf(code); }
            if (AppAmba.name().equals(name())) { return WebCDef.AppAmba.codeOf(code); }
            if (AppMiraco.name().equals(name())) { return WebCDef.AppMiraco.codeOf(code); }
            if (AppDohotel.name().equals(name())) { return WebCDef.AppDohotel.codeOf(code); }
            if (AppFlg.name().equals(name())) { return WebCDef.AppFlg.codeOf(code); }
            if (AppPaymentMethod.name().equals(name())) { return WebCDef.AppPaymentMethod.codeOf(code); }
            if (DeepWxLiteralGrouping.name().equals(name())) { return WebCDef.DeepWxLiteralGrouping.codeOf(code); }
            if (DeepWxDeprecatedCls.name().equals(name())) { return WebCDef.DeepWxDeprecatedCls.codeOf(code); }
            if (DeepWxDeprecatedElement.name().equals(name())) { return WebCDef.DeepWxDeprecatedElement.codeOf(code); }
            throw new IllegalStateException("Unknown definition: " + this); // basically unreachable
        }

        public Classification nameOf(String name) { // null if not found, old style so use byName(name)
            if (AppSea.name().equals(name())) { return WebCDef.AppSea.valueOf(name); }
            if (AppLand.name().equals(name())) { return WebCDef.AppLand.valueOf(name); }
            if (AppPiari.name().equals(name())) { return WebCDef.AppPiari.valueOf(name); }
            if (AppBonvo.name().equals(name())) { return WebCDef.AppBonvo.valueOf(name); }
            if (AppDstore.name().equals(name())) { return WebCDef.AppDstore.valueOf(name); }
            if (AppAmba.name().equals(name())) { return WebCDef.AppAmba.valueOf(name); }
            if (AppMiraco.name().equals(name())) { return WebCDef.AppMiraco.valueOf(name); }
            if (AppDohotel.name().equals(name())) { return WebCDef.AppDohotel.valueOf(name); }
            if (AppFlg.name().equals(name())) { return WebCDef.AppFlg.valueOf(name); }
            if (AppPaymentMethod.name().equals(name())) { return WebCDef.AppPaymentMethod.valueOf(name); }
            if (DeepWxLiteralGrouping.name().equals(name())) { return WebCDef.DeepWxLiteralGrouping.valueOf(name); }
            if (DeepWxDeprecatedCls.name().equals(name())) { return WebCDef.DeepWxDeprecatedCls.valueOf(name); }
            if (DeepWxDeprecatedElement.name().equals(name())) { return WebCDef.DeepWxDeprecatedElement.valueOf(name); }
            throw new IllegalStateException("Unknown definition: " + this); // basically unreachable
        }

        public List<Classification> listAll() {
            if (AppSea.name().equals(name())) { return toClsList(WebCDef.AppSea.listAll()); }
            if (AppLand.name().equals(name())) { return toClsList(WebCDef.AppLand.listAll()); }
            if (AppPiari.name().equals(name())) { return toClsList(WebCDef.AppPiari.listAll()); }
            if (AppBonvo.name().equals(name())) { return toClsList(WebCDef.AppBonvo.listAll()); }
            if (AppDstore.name().equals(name())) { return toClsList(WebCDef.AppDstore.listAll()); }
            if (AppAmba.name().equals(name())) { return toClsList(WebCDef.AppAmba.listAll()); }
            if (AppMiraco.name().equals(name())) { return toClsList(WebCDef.AppMiraco.listAll()); }
            if (AppDohotel.name().equals(name())) { return toClsList(WebCDef.AppDohotel.listAll()); }
            if (AppFlg.name().equals(name())) { return toClsList(WebCDef.AppFlg.listAll()); }
            if (AppPaymentMethod.name().equals(name())) { return toClsList(WebCDef.AppPaymentMethod.listAll()); }
            if (DeepWxLiteralGrouping.name().equals(name())) { return toClsList(WebCDef.DeepWxLiteralGrouping.listAll()); }
            if (DeepWxDeprecatedCls.name().equals(name())) { return toClsList(WebCDef.DeepWxDeprecatedCls.listAll()); }
            if (DeepWxDeprecatedElement.name().equals(name())) { return toClsList(WebCDef.DeepWxDeprecatedElement.listAll()); }
            throw new IllegalStateException("Unknown definition: " + this); // basically unreachable
        }

        public List<Classification> listByGroup(String groupName) { // exception if not found
            if (AppSea.name().equals(name())) { return toClsList(WebCDef.AppSea.listByGroup(groupName)); }
            if (AppLand.name().equals(name())) { return toClsList(WebCDef.AppLand.listByGroup(groupName)); }
            if (AppPiari.name().equals(name())) { return toClsList(WebCDef.AppPiari.listByGroup(groupName)); }
            if (AppBonvo.name().equals(name())) { return toClsList(WebCDef.AppBonvo.listByGroup(groupName)); }
            if (AppDstore.name().equals(name())) { return toClsList(WebCDef.AppDstore.listByGroup(groupName)); }
            if (AppAmba.name().equals(name())) { return toClsList(WebCDef.AppAmba.listByGroup(groupName)); }
            if (AppMiraco.name().equals(name())) { return toClsList(WebCDef.AppMiraco.listByGroup(groupName)); }
            if (AppDohotel.name().equals(name())) { return toClsList(WebCDef.AppDohotel.listByGroup(groupName)); }
            if (AppFlg.name().equals(name())) { return toClsList(WebCDef.AppFlg.listByGroup(groupName)); }
            if (AppPaymentMethod.name().equals(name())) { return toClsList(WebCDef.AppPaymentMethod.listByGroup(groupName)); }
            if (DeepWxLiteralGrouping.name().equals(name())) { return toClsList(WebCDef.DeepWxLiteralGrouping.listByGroup(groupName)); }
            if (DeepWxDeprecatedCls.name().equals(name())) { return toClsList(WebCDef.DeepWxDeprecatedCls.listByGroup(groupName)); }
            if (DeepWxDeprecatedElement.name().equals(name())) { return toClsList(WebCDef.DeepWxDeprecatedElement.listByGroup(groupName)); }
        ...
        public List<Classification> listOf(Collection<String> codeList) {
            if (AppSea.name().equals(name())) { return toClsList(WebCDef.AppSea.listOf(codeList)); }
            if (AppLand.name().equals(name())) { return toClsList(WebCDef.AppLand.listOf(codeList)); }
            if (AppPiari.name().equals(name())) { return toClsList(WebCDef.AppPiari.listOf(codeList)); }
            if (AppBonvo.name().equals(name())) { return toClsList(WebCDef.AppBonvo.listOf(codeList)); }
            if (AppDstore.name().equals(name())) { return toClsList(WebCDef.AppDstore.listOf(codeList)); }
            if (AppAmba.name().equals(name())) { return toClsList(WebCDef.AppAmba.listOf(codeList)); }
            if (AppMiraco.name().equals(name())) { return toClsList(WebCDef.AppMiraco.listOf(codeList)); }
            if (AppDohotel.name().equals(name())) { return toClsList(WebCDef.AppDohotel.listOf(codeList)); }
            if (AppFlg.name().equals(name())) { return toClsList(WebCDef.AppFlg.listOf(codeList)); }
            if (AppPaymentMethod.name().equals(name())) { return toClsList(WebCDef.AppPaymentMethod.listOf(codeList)); }
            if (DeepWxLiteralGrouping.name().equals(name())) { return toClsList(WebCDef.DeepWxLiteralGrouping.listOf(codeList)); }
            if (DeepWxDeprecatedCls.name().equals(name())) { return toClsList(WebCDef.DeepWxDeprecatedCls.listOf(codeList)); }
            if (DeepWxDeprecatedElement.name().equals(name())) { return toClsList(WebCDef.DeepWxDeprecatedElement.listOf(codeList)); }
            throw new IllegalStateException("Unknown definition: " + this); // basically unreachable
        }

        public List<Classification> groupOf(String groupName) { // old style
            if (AppSea.name().equals(name())) { return toClsList(WebCDef.AppSea.groupOf(groupName)); }
            if (AppLand.name().equals(name())) { return toClsList(WebCDef.AppLand.groupOf(groupName)); }
            if (AppPiari.name().equals(name())) { return toClsList(WebCDef.AppPiari.groupOf(groupName)); }
            if (AppBonvo.name().equals(name())) { return toClsList(WebCDef.AppBonvo.groupOf(groupName)); }
            if (AppDstore.name().equals(name())) { return toClsList(WebCDef.AppDstore.groupOf(groupName)); }
            if (AppAmba.name().equals(name())) { return toClsList(WebCDef.AppAmba.groupOf(groupName)); }
            if (AppMiraco.name().equals(name())) { return toClsList(WebCDef.AppMiraco.groupOf(groupName)); }
            if (AppDohotel.name().equals(name())) { return toClsList(WebCDef.AppDohotel.groupOf(groupName)); }
            if (AppFlg.name().equals(name())) { return toClsList(WebCDef.AppFlg.groupOf(groupName)); }
            if (AppPaymentMethod.name().equals(name())) { return toClsList(WebCDef.AppPaymentMethod.groupOf(groupName)); }
            if (DeepWxLiteralGrouping.name().equals(name())) { return toClsList(WebCDef.DeepWxLiteralGrouping.groupOf(groupName)); }
            if (DeepWxDeprecatedCls.name().equals(name())) { return toClsList(WebCDef.DeepWxDeprecatedCls.groupOf(groupName)); }
            if (DeepWxDeprecatedElement.name().equals(name())) { return toClsList(WebCDef.DeepWxDeprecatedElement.groupOf(groupName)); }
            throw new IllegalStateException("Unknown definition: " + this); // basically unreachable
        }
        ...
        public static OptionalThing<WebCDef.DefMeta> find(String classificationName) { // instead of valueOf()
            ...
            if (AppSea.name().equalsIgnoreCase(classificationName)) { return OptionalThing.of(WebCDef.DefMeta.AppSea); }
            if (AppLand.name().equalsIgnoreCase(classificationName)) { return OptionalThing.of(WebCDef.DefMeta.AppLand); }
            if (AppPiari.name().equalsIgnoreCase(classificationName)) { return OptionalThing.of(WebCDef.DefMeta.AppPiari); }
            if (AppBonvo.name().equalsIgnoreCase(classificationName)) { return OptionalThing.of(WebCDef.DefMeta.AppBonvo); }
            if (AppDstore.name().equalsIgnoreCase(classificationName)) { return OptionalThing.of(WebCDef.DefMeta.AppDstore); }
            if (AppAmba.name().equalsIgnoreCase(classificationName)) { return OptionalThing.of(WebCDef.DefMeta.AppAmba); }
            if (AppMiraco.name().equalsIgnoreCase(classificationName)) { return OptionalThing.of(WebCDef.DefMeta.AppMiraco); }
            if (AppDohotel.name().equalsIgnoreCase(classificationName)) { return OptionalThing.of(WebCDef.DefMeta.AppDohotel); }
            if (AppFlg.name().equalsIgnoreCase(classificationName)) { return OptionalThing.of(WebCDef.DefMeta.AppFlg); }
            if (AppPaymentMethod.name().equalsIgnoreCase(classificationName)) { return OptionalThing.of(WebCDef.DefMeta.AppPaymentMethod); }
            if (DeepWxLiteralGrouping.name().equalsIgnoreCase(classificationName)) { return OptionalThing.of(WebCDef.DefMeta.DeepWxLiteralGrouping); }
            if (DeepWxDeprecatedCls.name().equalsIgnoreCase(classificationName)) { return OptionalThing.of(WebCDef.DefMeta.DeepWxDeprecatedCls); }
            if (DeepWxDeprecatedElement.name().equalsIgnoreCase(classificationName)) { return OptionalThing.of(WebCDef.DefMeta.DeepWxDeprecatedElement); }
        ...
        public static WebCDef.DefMeta meta(String classificationName) { // old style so use find(name)
            if (classificationName == null) { throw new IllegalArgumentException("The argument 'classificationName' should not be null."); }
            if (AppSea.name().equalsIgnoreCase(classificationName)) { return WebCDef.DefMeta.AppSea; }
            if (AppLand.name().equalsIgnoreCase(classificationName)) { return WebCDef.DefMeta.AppLand; }
            if (AppPiari.name().equalsIgnoreCase(classificationName)) { return WebCDef.DefMeta.AppPiari; }
            if (AppBonvo.name().equalsIgnoreCase(classificationName)) { return WebCDef.DefMeta.AppBonvo; }
            if (AppDstore.name().equalsIgnoreCase(classificationName)) { return WebCDef.DefMeta.AppDstore; }
            if (AppAmba.name().equalsIgnoreCase(classificationName)) { return WebCDef.DefMeta.AppAmba; }
            if (AppMiraco.name().equalsIgnoreCase(classificationName)) { return WebCDef.DefMeta.AppMiraco; }
            if (AppDohotel.name().equalsIgnoreCase(classificationName)) { return WebCDef.DefMeta.AppDohotel; }
            if (AppFlg.name().equalsIgnoreCase(classificationName)) { return WebCDef.DefMeta.AppFlg; }
            if (AppPaymentMethod.name().equalsIgnoreCase(classificationName)) { return WebCDef.DefMeta.AppPaymentMethod; }
            if (DeepWxLiteralGrouping.name().equalsIgnoreCase(classificationName)) { return WebCDef.DefMeta.DeepWxLiteralGrouping; }
            if (DeepWxDeprecatedCls.name().equalsIgnoreCase(classificationName)) { return WebCDef.DefMeta.DeepWxDeprecatedCls; }
            if (DeepWxDeprecatedElement.name().equalsIgnoreCase(classificationName)) { return WebCDef.DefMeta.DeepWxDeprecatedElement; }
