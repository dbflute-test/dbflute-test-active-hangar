...
/**
 * The simple DTO of WHITE_UNEVEN_COMMON_COLUMN_1ST as TABLE. <br>
 * <pre>
 * [primary-key]
 *     UNEVEN_ID
 *
...
public abstract class BsWhiteUnevenCommonColumn1stDto implements Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsWhiteUnevenCommonColumn1stDto() {
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsWhiteUnevenCommonColumn1stDto)) { return false; }
        final BsWhiteUnevenCommonColumn1stDto otherEntity = (BsWhiteUnevenCommonColumn1stDto)other;
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "WHITE_UNEVEN_COMMON_COLUMN_1ST");
