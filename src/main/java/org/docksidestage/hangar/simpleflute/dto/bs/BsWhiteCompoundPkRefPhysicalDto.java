...
/**
 * The simple DTO of WHITE_COMPOUND_PK_REF_PHYSICAL as TABLE. <br>
 * <pre>
 * [primary-key]
...
public abstract class BsWhiteCompoundPkRefPhysicalDto implements Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsWhiteCompoundPkRefPhysicalDto() {
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsWhiteCompoundPkRefPhysicalDto)) { return false; }
        final BsWhiteCompoundPkRefPhysicalDto otherEntity = (BsWhiteCompoundPkRefPhysicalDto)other;
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "WHITE_COMPOUND_PK_REF_PHYSICAL");
