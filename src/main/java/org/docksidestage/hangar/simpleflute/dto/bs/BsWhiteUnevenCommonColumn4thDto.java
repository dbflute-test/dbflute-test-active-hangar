...
/**
 * The simple DTO of WHITE_UNEVEN_COMMON_COLUMN_4TH as TABLE. <br>
 * <pre>
 * [primary-key]
 *     UNEVEN_ID
 *
...
public abstract class BsWhiteUnevenCommonColumn4thDto implements Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsWhiteUnevenCommonColumn4thDto() {
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsWhiteUnevenCommonColumn4thDto)) { return false; }
        final BsWhiteUnevenCommonColumn4thDto otherEntity = (BsWhiteUnevenCommonColumn4thDto)other;
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "WHITE_UNEVEN_COMMON_COLUMN_4TH");
