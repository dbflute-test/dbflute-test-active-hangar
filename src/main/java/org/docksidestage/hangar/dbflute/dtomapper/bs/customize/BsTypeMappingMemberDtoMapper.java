...
/**
 * The DTO mapper of TypeMappingMember. <br>
 * <pre>
 * [primary-key]
 *     
 *
 ...
 */
public abstract class BsTypeMappingMemberDtoMapper implements DtoMapper<TypeMappingMember, TypeMappingMemberDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsTypeMappingMemberDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsTypeMappingMemberDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public TypeMappingMemberDto mappingToDto(TypeMappingMember entity) {
        if (entity == null) {
            return null;
        }
        TypeMappingMemberDto dto = new TypeMappingMemberDto();
     ...
     * {@inheritDoc}
     */
    public List<TypeMappingMemberDto> mappingToDtoList(List<TypeMappingMember> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<TypeMappingMemberDto> dtoList = new ArrayList<TypeMappingMemberDto>();
        for (TypeMappingMember entity : entityList) {
            TypeMappingMemberDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public TypeMappingMember mappingToEntity(TypeMappingMemberDto dto) {
        if (dto == null) {
            return null;
        }
        TypeMappingMember entity = new TypeMappingMember();
     ...
     */
    protected boolean needsMapping(TypeMappingMemberDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<TypeMappingMember> mappingToEntityList(List<TypeMappingMemberDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<TypeMappingMember> entityList = new ArrayList<TypeMappingMember>();
        for (TypeMappingMemberDto dto : dtoList) {
            TypeMappingMember entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public TypeMappingMemberDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (TypeMappingMemberDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public TypeMappingMemberDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public TypeMappingMemberDtoMapper reverseReference() {
