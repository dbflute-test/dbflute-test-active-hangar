 ...
 */
public class ResolaBsPurchaseCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected ResolaPurchaseCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public ResolaBsPurchaseCB() {
     ...
     * @return this. (NotNull)
     */
    public ResolaPurchaseCB acceptPK(Long purchaseId) {
        assertObjectNotNull("purchaseId", purchaseId);
        ResolaBsPurchaseCB cb = this;
        cb.query().setPurchaseId_Equal(purchaseId);
        return (ResolaPurchaseCB)this;
    }
     ...
     * @return this. (NotNull)
     */
    public ResolaPurchaseCB acceptUniqueOf(Integer memberId, Integer productId, java.time.LocalDateTime purchaseDatetime) {
     ...
     */
    public ResolaPurchaseCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public ResolaPurchaseCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected ResolaPurchaseCQ doGetConditionQuery() {
    ...
    protected ResolaPurchaseCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected ResolaPurchaseCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        ResolaPurchaseCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected ResolaPurchaseCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new ResolaPurchaseCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<ResolaPurchaseCB> unionCBLambda) {
        final ResolaPurchaseCB cb = new ResolaPurchaseCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final ResolaPurchaseCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<ResolaPurchaseCB> unionCBLambda) {
        final ResolaPurchaseCB cb = new ResolaPurchaseCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final ResolaPurchaseCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<ResolaPurchaseCQ> {
        protected ResolaMemberCB.HpSpecification _member;
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<ResolaPurchaseCQ> qyCall
        ...
        protected void doSpecifyRequiredColumn() {
            ...
            if (qyCall().qy().hasConditionQueryMember()
                    || qyCall().qy().xgetReferrerQuery() instanceof ResolaMemberCQ) {
         ...
         */
        public HpSDRFunction<ResolaPurchaseCB, ResolaPurchaseCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<ResolaPurchaseCB> sq, ResolaPurchaseCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public ResolaPurchaseCB dreamCruiseCB() {
        ResolaPurchaseCB cb = new ResolaPurchaseCB();
        cb.xsetupForDreamCruise((ResolaPurchaseCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<ResolaPurchaseCB> columnQuery(final SpecifyQuery<ResolaPurchaseCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected ResolaPurchaseCB xcreateColumnQueryCB() {
        ResolaPurchaseCB cb = new ResolaPurchaseCB();
        cb.xsetupForColumnQuery((ResolaPurchaseCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<ResolaPurchaseCB> orCBLambda) {
        xorSQ((ResolaPurchaseCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<ResolaPurchaseCB> andCBLambda) {
        xorSQAP((ResolaPurchaseCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final ResolaPurchaseCB cb;
        if (mainCB != null) {
            cb = (ResolaPurchaseCB)mainCB;
        } else {
            cb = new ResolaPurchaseCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return ResolaPurchaseCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return ResolaPurchaseCQ.class.getName(); }
