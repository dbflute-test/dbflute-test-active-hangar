 ...
 */
public abstract class ResolaBsMember extends AbstractEntity implements DomainEntity {
    ...
    protected OptionalEntity<ResolaMemberSecurity> _memberSecurityAsOne;
     ...
     */
    public OptionalEntity<ResolaMemberSecurity> getMemberSecurityAsOne() {
     ...
     */
    public void setMemberSecurityAsOne(OptionalEntity<ResolaMemberSecurity> memberSecurityAsOne) {
    ...
    protected List<ResolaPurchase> _purchaseList;

    /**
     * [get] PURCHASE by MEMBER_ID, named 'purchaseList'.
     * @return The entity list of referrer property 'purchaseList'. (NotNull: even if no loading, returns empty list)
     */
    public List<ResolaPurchase> getPurchaseList() {
     ...
     */
    public void setPurchaseList(List<ResolaPurchase> purchaseList) {
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof ResolaBsMember) {
            ResolaBsMember other = (ResolaBsMember)obj;
    ...
    protected String doBuildStringWithRelation(String li) {
        ...
        if (_purchaseList != null) { for (ResolaPurchase et : _purchaseList)
    ...
    @Override
    public ResolaMember clone() {
        return (ResolaMember)super.clone();
    }
