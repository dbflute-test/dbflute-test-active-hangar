 ...
 */
public abstract class ResolaAbstractBsPurchaseCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public ResolaAbstractBsPurchaseCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     */
    public HpSLCFunction<ResolaPurchaseCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, ResolaPurchaseCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ResolaPurchaseCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, ResolaPurchaseCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ResolaPurchaseCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, ResolaPurchaseCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ResolaPurchaseCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, ResolaPurchaseCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ResolaPurchaseCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, ResolaPurchaseCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;ResolaPurchaseCB&gt;() {
     *     public void query(ResolaPurchaseCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ResolaPurchaseCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, ResolaPurchaseCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        ResolaPurchaseCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(ResolaPurchaseCQ sq);

    protected ResolaPurchaseCB xcreateScalarConditionCB() {
        ResolaPurchaseCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected ResolaPurchaseCB xcreateScalarConditionPartitionByCB() {
        ResolaPurchaseCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<ResolaPurchaseCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
    ...
    public abstract String keepSpecifyMyselfDerived(ResolaPurchaseCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<ResolaPurchaseCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(ResolaPurchaseCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        ResolaPurchaseCB cb = new ResolaPurchaseCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "PURCHASE_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(ResolaPurchaseCQ sq);
     ...
     */
    public void myselfExists(SubQuery<ResolaPurchaseCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        ResolaPurchaseCB cb = new ResolaPurchaseCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(ResolaPurchaseCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected ResolaPurchaseCB newMyCB() {
        return new ResolaPurchaseCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return ResolaPurchaseCQ.class.getName(); }
