 ...
 */
public abstract class ResolaAbstractBsMemberSecurityCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public ResolaAbstractBsMemberSecurityCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     */
    public HpSLCFunction<ResolaMemberSecurityCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, ResolaMemberSecurityCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ResolaMemberSecurityCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, ResolaMemberSecurityCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ResolaMemberSecurityCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, ResolaMemberSecurityCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ResolaMemberSecurityCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, ResolaMemberSecurityCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ResolaMemberSecurityCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, ResolaMemberSecurityCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;ResolaMemberSecurityCB&gt;() {
     *     public void query(ResolaMemberSecurityCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ResolaMemberSecurityCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, ResolaMemberSecurityCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        ResolaMemberSecurityCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(ResolaMemberSecurityCQ sq);

    protected ResolaMemberSecurityCB xcreateScalarConditionCB() {
        ResolaMemberSecurityCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected ResolaMemberSecurityCB xcreateScalarConditionPartitionByCB() {
        ResolaMemberSecurityCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<ResolaMemberSecurityCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        ResolaMemberSecurityCB cb = new ResolaMemberSecurityCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "MEMBER_ID";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(ResolaMemberSecurityCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<ResolaMemberSecurityCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(ResolaMemberSecurityCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        ResolaMemberSecurityCB cb = new ResolaMemberSecurityCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "MEMBER_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(ResolaMemberSecurityCQ sq);
     ...
     */
    public void myselfExists(SubQuery<ResolaMemberSecurityCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        ResolaMemberSecurityCB cb = new ResolaMemberSecurityCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(ResolaMemberSecurityCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected ResolaMemberSecurityCB newMyCB() {
        return new ResolaMemberSecurityCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return ResolaMemberSecurityCQ.class.getName(); }
