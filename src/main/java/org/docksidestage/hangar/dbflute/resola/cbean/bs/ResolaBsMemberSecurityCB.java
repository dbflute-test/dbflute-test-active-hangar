 ...
 */
public class ResolaBsMemberSecurityCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected ResolaMemberSecurityCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public ResolaBsMemberSecurityCB() {
     ...
     * @return this. (NotNull)
     */
    public ResolaMemberSecurityCB acceptPK(Integer memberId) {
        assertObjectNotNull("memberId", memberId);
        ResolaBsMemberSecurityCB cb = this;
        cb.query().setMemberId_Equal(memberId);
        return (ResolaMemberSecurityCB)this;
    }
     ...
     */
    public ResolaMemberSecurityCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public ResolaMemberSecurityCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected ResolaMemberSecurityCQ doGetConditionQuery() {
    ...
    protected ResolaMemberSecurityCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected ResolaMemberSecurityCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        ResolaMemberSecurityCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected ResolaMemberSecurityCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new ResolaMemberSecurityCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<ResolaMemberSecurityCB> unionCBLambda) {
        final ResolaMemberSecurityCB cb = new ResolaMemberSecurityCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final ResolaMemberSecurityCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<ResolaMemberSecurityCB> unionCBLambda) {
        final ResolaMemberSecurityCB cb = new ResolaMemberSecurityCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final ResolaMemberSecurityCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }

    // ===================================================================================
    //                                                                         SetupSelect
    //                                                                         ===========
    protected ResolaMemberNss _nssMember;
    public ResolaMemberNss xdfgetNssMember() {
        if (_nssMember == null) { _nssMember = new ResolaMemberNss(null); }
        return _nssMember;
    }
    /**
    ...
    public static class HpSpecification extends HpAbstractSpecification<ResolaMemberSecurityCQ> {
        protected ResolaMemberCB.HpSpecification _member;
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<ResolaMemberSecurityCQ> qyCall
         ...
         */
        public ResolaMemberCB.HpSpecification specifyMember() {
            assertRelation("member");
            if (_member == null) {
                _member = new ResolaMemberCB.HpSpecification(_baseCB
         ...
         */
        public HpSDRFunction<ResolaMemberSecurityCB, ResolaMemberSecurityCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<ResolaMemberSecurityCB> sq, ResolaMemberSecurityCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public ResolaMemberSecurityCB dreamCruiseCB() {
        ResolaMemberSecurityCB cb = new ResolaMemberSecurityCB();
        cb.xsetupForDreamCruise((ResolaMemberSecurityCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<ResolaMemberSecurityCB> columnQuery(final SpecifyQuery<ResolaMemberSecurityCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected ResolaMemberSecurityCB xcreateColumnQueryCB() {
        ResolaMemberSecurityCB cb = new ResolaMemberSecurityCB();
        cb.xsetupForColumnQuery((ResolaMemberSecurityCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<ResolaMemberSecurityCB> orCBLambda) {
        xorSQ((ResolaMemberSecurityCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<ResolaMemberSecurityCB> andCBLambda) {
        xorSQAP((ResolaMemberSecurityCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final ResolaMemberSecurityCB cb;
        if (mainCB != null) {
            cb = (ResolaMemberSecurityCB)mainCB;
        } else {
            cb = new ResolaMemberSecurityCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return ResolaMemberSecurityCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return ResolaMemberSecurityCQ.class.getName(); }
