 ...
 */
public abstract class ResolaBsMemberBhv extends AbstractBehaviorWritable<ResolaMember, ResolaMemberCB> {
    ...
    //                                                                             =======
    /** {@inheritDoc} */
    public ResolaMemberDbm asDBMeta() { return ResolaMemberDbm.getInstance(); }
    /** {@inheritDoc} */
    ...
    //                                                                        ============
    /** {@inheritDoc} */
    public ResolaMemberCB newConditionBean() { return new ResolaMemberCB(); }
     ...
     * });
     * </pre>
     * @param cbLambda The callback for condition-bean of ResolaMember. (NotNull)
     * @return The count for the condition. (NotMinus)
     */
    public int selectCount(CBCall<ResolaMemberCB> cbLambda) {
     ...
     */
    public OptionalEntity<ResolaMember> selectEntity(CBCall<ResolaMemberCB> cbLambda) {
        return facadeSelectEntity(createCB(cbLambda));
    }

    protected OptionalEntity<ResolaMember> facadeSelectEntity(ResolaMemberCB cb) {
        return doSelectOptionalEntity(cb, typeOfSelectedEntity());
    }

    protected <ENTITY extends ResolaMember> OptionalEntity<ENTITY> doSelectOptionalEntity(ResolaMemberCB cb, Class<? extends ENTITY> tp) {
     ...
     * <pre>
     * ResolaMember <span style="color: #553000">member</span> = <span style="color: #0000C0">memberBhv</span>.<span style="color: #CC4747">selectEntityWithDeletedCheck</span>(cb <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> cb.acceptPK(1));
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public ResolaMember selectEntityWithDeletedCheck(CBCall<ResolaMemberCB> cbLambda) {
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public OptionalEntity<ResolaMember> selectByPK(Integer memberId) {
        return facadeSelectByPK(memberId);
    }

    protected OptionalEntity<ResolaMember> facadeSelectByPK(Integer memberId) {
        return doSelectOptionalByPK(memberId, typeOfSelectedEntity());
    }

    protected <ENTITY extends ResolaMember> ENTITY doSelectByPK(Integer memberId, Class<? extends ENTITY> tp) {
        return doSelectEntity(xprepareCBAsPK(memberId), tp);
    }

    protected <ENTITY extends ResolaMember> OptionalEntity<ENTITY> doSelectOptionalByPK(Integer memberId, Class<? extends ENTITY> tp) {
        return createOptionalEntity(doSelectByPK(memberId, tp), memberId);
    }

    protected ResolaMemberCB xprepareCBAsPK(Integer memberId) {
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public OptionalEntity<ResolaMember> selectByUniqueOf(String memberAccount) {
        return facadeSelectByUniqueOf(memberAccount);
    }

    protected OptionalEntity<ResolaMember> facadeSelectByUniqueOf(String memberAccount) {
        return doSelectByUniqueOf(memberAccount, typeOfSelectedEntity());
    }

    protected <ENTITY extends ResolaMember> OptionalEntity<ENTITY> doSelectByUniqueOf(String memberAccount, Class<? extends ENTITY> tp) {
        return createOptionalEntity(doSelectEntity(xprepareCBAsUniqueOf(memberAccount), tp), memberAccount);
    }

    protected ResolaMemberCB xprepareCBAsUniqueOf(String memberAccount) {
     ...
     * <pre>
     * ListResultBean&lt;ResolaMember&gt; <span style="color: #553000">memberList</span> = <span style="color: #0000C0">memberBhv</span>.<span style="color: #CC4747">selectList</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...;
     *     <span style="color: #553000">cb</span>.query().addOrderBy...;
     * });
     * <span style="color: #70226C">for</span> (ResolaMember <span style="color: #553000">member</span> : <span style="color: #553000">memberList</span>) {
     *     ... = <span style="color: #553000">member</span>.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of ResolaMember. (NotNull)
     ...
     */
    public ListResultBean<ResolaMember> selectList(CBCall<ResolaMemberCB> cbLambda) {
     ...
     * <pre>
     * PagingResultBean&lt;ResolaMember&gt; <span style="color: #553000">page</span> = <span style="color: #0000C0">memberBhv</span>.<span style="color: #CC4747">selectPage</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...
     *     <span style="color: #553000">cb</span>.query().addOrderBy...
     ...
     * ...
     * <span style="color: #70226C">for</span> (ResolaMember member : <span style="color: #553000">page</span>) {
     *     ... = member.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of ResolaMember. (NotNull)
     ...
     * @throws DangerousResultSizeException When the result size is over the specified safety size.
     */
    public PagingResultBean<ResolaMember> selectPage(CBCall<ResolaMemberCB> cbLambda) {
     ...
     * </pre>
     * @param cbLambda The callback for condition-bean of ResolaMember. (NotNull)
     * @param entityLambda The handler of entity row of ResolaMember. (NotNull)
     */
    public void selectCursor(CBCall<ResolaMemberCB> cbLambda, EntityRowHandler<ResolaMember> entityLambda) {
     ...
     */
    public <RESULT> HpSLSFunction<ResolaMemberCB, RESULT> selectScalar(Class<RESULT> resultType) {
     ...
     */
    public void load(List<ResolaMember> memberList, ReferrerLoaderHandler<ResolaLoaderOfMember> loaderLambda) {
        xassLRArg(memberList, loaderLambda);
        loaderLambda.handle(new ResolaLoaderOfMember().ready(memberList, _behaviorSelector));
    }
     ...
     * @param loaderLambda The callback to handle the referrer loader for actually loading referrer. (NotNull)
     */
    public void load(ResolaMember member, ReferrerLoaderHandler<ResolaLoaderOfMember> loaderLambda) {
        xassLRArg(member, loaderLambda);
        loaderLambda.handle(new ResolaLoaderOfMember().ready(xnewLRAryLs(member), _behaviorSelector));
    }
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * <span style="color: #70226C">for</span> (ResolaMember member : <span style="color: #553000">memberList</span>) {
     ...
     */
    public NestedReferrerListGateway<ResolaPurchase> loadPurchase(List<ResolaMember> memberList, ReferrerConditionSetupper<ResolaPurchaseCB> refCBLambda) {
        xassLRArg(memberList, refCBLambda);
        return doLoadPurchase(memberList, new LoadReferrerOption<ResolaPurchaseCB, ResolaPurchase>().xinit(refCBLambda));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<ResolaPurchase> loadPurchase(ResolaMember member, ReferrerConditionSetupper<ResolaPurchaseCB> refCBLambda) {
        xassLRArg(member, refCBLambda);
        return doLoadPurchase(xnewLRLs(member), new LoadReferrerOption<ResolaPurchaseCB, ResolaPurchase>().xinit(refCBLambda));
    }

    protected NestedReferrerListGateway<ResolaPurchase> doLoadPurchase(List<ResolaMember> memberList, LoadReferrerOption<ResolaPurchaseCB, ResolaPurchase> option) {
    ...
    //                                                                   =================
    /**
     * Pull out the list of referrer-as-one table 'ResolaMemberSecurity'.
     * @param memberList The list of member. (NotNull, EmptyAllowed)
     * @return The list of referrer-as-one table. (NotNull, EmptyAllowed, NotNullElement)
     */
    public List<ResolaMemberSecurity> pulloutMemberSecurityAsOne(List<ResolaMember> memberList)
     ...
     */
    public List<Integer> extractMemberIdList(List<ResolaMember> memberList)
     ...
     * @return The list of the column value. (NotNull, EmptyAllowed, NotNullElement)
     */
    public List<String> extractMemberAccountList(List<ResolaMember> memberList)
     ...
     * <pre>
     * ResolaMember member = <span style="color: #70226C">new</span> ResolaMember();
     ...
     */
    public void insert(ResolaMember member) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void update(ResolaMember member) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void updateNonstrict(ResolaMember member) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void insertOrUpdate(ResolaMember member) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void insertOrUpdateNonstrict(ResolaMember member) {
     ...
     * @throws EntityDuplicatedException When the entity has been duplicated.
     */
    public void delete(ResolaMember member) {
     ...
     * @throws EntityDuplicatedException When the entity has been duplicated.
     */
    public void deleteNonstrict(ResolaMember member) {
     ...
     */
    public int[] batchInsert(List<ResolaMember> memberList) {
     ...
     */
    public int[] batchUpdate(List<ResolaMember> memberList) {
     ...
     * @throws EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     */
    public int[] batchUpdateNonstrict(List<ResolaMember> memberList) {
     ...
     * @throws BatchEntityAlreadyUpdatedException When the entity has already been updated. This exception extends EntityAlreadyUpdatedException.
     */
    public int[] batchDelete(List<ResolaMember> memberList) {
     ...
     * @throws EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     */
    public int[] batchDeleteNonstrict(List<ResolaMember> memberList) {
     ...
     * <pre>
     * <span style="color: #0000C0">memberBhv</span>.<span style="color: #CC4747">queryInsert</span>(new QueryInsertSetupper&lt;ResolaMember, ResolaMemberCB&gt;() {
     *     public ConditionBean setup(ResolaMember entity, ResolaMemberCB intoCB) {
     *         FooCB cb = FooCB();
     *         cb.setupSelect_Bar();
     *
     ...
     */
    public int queryInsert(QueryInsertSetupper<ResolaMember, ResolaMemberCB> manyArgLambda) {
     ...
     */
    public int queryUpdate(ResolaMember member, CBCall<ResolaMemberCB> cbLambda) {
     ...
     */
    public int queryDelete(CBCall<ResolaMemberCB> cbLambda) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsert(ResolaMember member, WritableOptionCall<ResolaMemberCB, InsertOption<ResolaMemberCB>> opLambda) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingUpdate(ResolaMember member, WritableOptionCall<ResolaMemberCB, UpdateOption<ResolaMemberCB>> opLambda) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingUpdateNonstrict(ResolaMember member, WritableOptionCall<ResolaMemberCB, UpdateOption<ResolaMemberCB>> opLambda) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsertOrUpdate(ResolaMember member, WritableOptionCall<ResolaMemberCB, InsertOption<ResolaMemberCB>> insertOpLambda, WritableOptionCall<ResolaMemberCB, UpdateOption<ResolaMemberCB>> updateOpLambda) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsertOrUpdateNonstrict(ResolaMember member, WritableOptionCall<ResolaMemberCB, InsertOption<ResolaMemberCB>> insertOpLambda, WritableOptionCall<ResolaMemberCB, UpdateOption<ResolaMemberCB>> updateOpLambda) {
     ...
     * @throws EntityDuplicatedException When the entity has been duplicated.
     */
    public void varyingDelete(ResolaMember member, WritableOptionCall<ResolaMemberCB, DeleteOption<ResolaMemberCB>> opLambda) {
     ...
     * @throws EntityDuplicatedException When the entity has been duplicated.
     */
    public void varyingDeleteNonstrict(ResolaMember member, WritableOptionCall<ResolaMemberCB, DeleteOption<ResolaMemberCB>> opLambda) {
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchInsert(List<ResolaMember> memberList, WritableOptionCall<ResolaMemberCB, InsertOption<ResolaMemberCB>> opLambda) {
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchUpdate(List<ResolaMember> memberList, WritableOptionCall<ResolaMemberCB, UpdateOption<ResolaMemberCB>> opLambda) {
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchUpdateNonstrict(List<ResolaMember> memberList, WritableOptionCall<ResolaMemberCB, UpdateOption<ResolaMemberCB>> opLambda) {
     ...
     * @return The array of deleted count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchDelete(List<ResolaMember> memberList, WritableOptionCall<ResolaMemberCB, DeleteOption<ResolaMemberCB>> opLambda) {
     ...
     * @return The array of deleted count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchDeleteNonstrict(List<ResolaMember> memberList, WritableOptionCall<ResolaMemberCB, DeleteOption<ResolaMemberCB>> opLambda) {
     ...
     * @return The inserted count.
     */
    public int varyingQueryInsert(QueryInsertSetupper<ResolaMember, ResolaMemberCB> manyArgLambda, WritableOptionCall<ResolaMemberCB, InsertOption<ResolaMemberCB>> opLambda) {
     ...
     */
    public int varyingQueryUpdate(ResolaMember member, CBCall<ResolaMemberCB> cbLambda, WritableOptionCall<ResolaMemberCB, UpdateOption<ResolaMemberCB>> opLambda) {
     ...
     */
    public int varyingQueryDelete(CBCall<ResolaMemberCB> cbLambda, WritableOptionCall<ResolaMemberCB, DeleteOption<ResolaMemberCB>> opLambda) {
     ...
     */
    public OutsideSqlAllFacadeExecutor<ResolaMemberBhv> outsideSql() {
        return doOutsideSql();
    }
    ...
    //                                                                         Type Helper
    //                                                                         ===========
    protected Class<? extends ResolaMember> typeOfSelectedEntity() { return ResolaMember.class; }
    protected Class<ResolaMember> typeOfHandlingEntity() { return ResolaMember.class; }
    protected Class<ResolaMemberCB> typeOfHandlingConditionBean() { return ResolaMemberCB.class; }
}
