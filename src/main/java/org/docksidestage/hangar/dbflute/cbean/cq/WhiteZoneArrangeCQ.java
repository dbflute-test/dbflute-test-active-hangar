...
import org.docksidestage.hangar.dbflute.cbean.cq.bs.BsWhiteZoneArrangeCQ;

/**
 * The condition-query of WHITE_ZONE_ARRANGE.
 * <p>
 ...
 */
public class WhiteZoneArrangeCQ extends BsWhiteZoneArrangeCQ {
     ...
     */
    public WhiteZoneArrangeCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
