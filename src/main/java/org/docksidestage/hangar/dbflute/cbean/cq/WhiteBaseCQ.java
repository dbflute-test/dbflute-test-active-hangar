...
import org.docksidestage.hangar.dbflute.cbean.cq.bs.BsWhiteBaseCQ;

/**
 * The condition-query of WHITE_BASE.
 * <p>
 ...
 */
public class WhiteBaseCQ extends BsWhiteBaseCQ {
     ...
     */
    public WhiteBaseCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
