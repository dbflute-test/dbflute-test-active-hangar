...
import org.docksidestage.hangar.dbflute.cbean.cq.bs.BsWhiteOnParadeCQ;

/**
 * The condition-query of WHITE_ON_PARADE.
 * <p>
 ...
 */
public class WhiteOnParadeCQ extends BsWhiteOnParadeCQ {
     ...
     */
    public WhiteOnParadeCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
