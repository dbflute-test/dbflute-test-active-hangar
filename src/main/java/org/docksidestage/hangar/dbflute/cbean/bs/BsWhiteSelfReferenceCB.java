...
public class BsWhiteSelfReferenceCB extends AbstractConditionBean {
     ...
     * @return this. (NotNull)
     */
    public WhiteSelfReferenceCB acceptPK(Integer selfReferenceId) {
    ...
    public static class HpSpecification extends HpAbstractSpecification<WhiteSelfReferenceCQ> {
         ...
         */
        public HpSDRFunction<WhiteSelfReferenceCB, WhiteSelfReferenceCQ> derivedWhiteSelfReferenceSelf() {
     ...
     */
    public HpColQyOperand<WhiteSelfReferenceCB> columnQuery(final SpecifyQuery<WhiteSelfReferenceCB> colCBLambda) {
