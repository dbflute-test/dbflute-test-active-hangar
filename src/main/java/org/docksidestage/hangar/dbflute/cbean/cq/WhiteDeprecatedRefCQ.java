...
import org.docksidestage.hangar.dbflute.cbean.cq.bs.BsWhiteDeprecatedRefCQ;

/**
 * The condition-query of WHITE_DEPRECATED_REF.
 * <p>
 ...
 */
public class WhiteDeprecatedRefCQ extends BsWhiteDeprecatedRefCQ {
     ...
     */
    public WhiteDeprecatedRefCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
