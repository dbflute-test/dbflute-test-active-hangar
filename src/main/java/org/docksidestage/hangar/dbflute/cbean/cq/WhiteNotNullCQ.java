...
import org.docksidestage.hangar.dbflute.cbean.cq.bs.BsWhiteNotNullCQ;

/**
 * The condition-query of WHITE_NOT_NULL.
 * <p>
 ...
 */
public class WhiteNotNullCQ extends BsWhiteNotNullCQ {
     ...
     */
    public WhiteNotNullCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
