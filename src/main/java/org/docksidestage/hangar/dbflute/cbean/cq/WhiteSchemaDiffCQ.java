...
import org.docksidestage.hangar.dbflute.cbean.cq.bs.BsWhiteSchemaDiffCQ;

/**
 * The condition-query of WHITE_SCHEMA_DIFF.
 * <p>
 ...
 */
public class WhiteSchemaDiffCQ extends BsWhiteSchemaDiffCQ {
     ...
     */
    public WhiteSchemaDiffCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
