 ...
 * Integer purchasePriceAvg = entity.getPurchasePriceAvg();
...
public abstract class BsMemberMonthlyPurchase extends AbstractEntity implements CustomizeEntity {
    ...
    public DBMeta asDBMeta() {
        return org.docksidestage.hangar.dbflute.bsentity.customize.dbmeta.MemberMonthlyPurchaseDbm.getInstance();
    }
