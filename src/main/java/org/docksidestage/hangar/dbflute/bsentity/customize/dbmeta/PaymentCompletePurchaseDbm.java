...
public class PaymentCompletePurchaseDbm extends AbstractDBMeta {
    ...
    protected final ColumnInfo _columnPurchaseDatetime = cci("PURCHASE_DATETIME", "PURCHASE_DATETIME", null, "購入日時", java.time.LocalDateTime.class, "purchaseDatetime", null, false, false, false, "TIMESTAMP", 26, 6, null, null, false, null, "購入した瞬間の日時。", null, null, null, false);
