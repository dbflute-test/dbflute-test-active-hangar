...
public abstract class BsWhiteOnParade extends AbstractEntity implements DomainEntity {
    ...
    /**
     * [get] WHITE_ON_PARADE_REF by NULLABLE_FK_ON_PARADE_ID, named 'whiteOnParadeRefList'.
    ...
    /**
     * [set] WHITE_ON_PARADE_REF by NULLABLE_FK_ON_PARADE_ID, named 'whiteOnParadeRefList'.
