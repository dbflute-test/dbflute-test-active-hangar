...
public class MemberMonthlyPurchaseDbm extends AbstractDBMeta {
    ...
    protected final ColumnInfo _columnMemberName = cci("MEMBER_NAME", "MEMBER_NAME", null, null, String.class, "memberName", null, false, false, false, "VARCHAR", 200, 0, null, null, false, null, "// non grouping item (1:1 data) is allowed on H2 database", null, null, null, false);
    ...
    protected final ColumnInfo _columnServicePointCount = cci("SERVICE_POINT_COUNT", "SERVICE_POINT_COUNT", null, null, Integer.class, "servicePointCount", null, false, false, false, "INTEGER", 10, 0, null, null, false, null, "// non grouping item (relationship 1:1 data) is allowed on H2 database", null, null, null, false);
