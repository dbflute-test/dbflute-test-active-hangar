...
/**
 * The entity of Sql2SimpleDtoExcept. <br>
 * <pre>
 * [primary-key]
 *     
 *
...
public abstract class BsSql2SimpleDtoExcept extends AbstractEntity implements CustomizeEntity {
    ...
    public DBMeta asDBMeta() {
        return org.docksidestage.hangar.dbflute.bsentity.customize.dbmeta.Sql2SimpleDtoExceptDbm.getInstance();
    }

    /** {@inheritDoc} */
    public String asTableDbName() {
        return "Sql2SimpleDtoExcept";
    }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsSql2SimpleDtoExcept) {
            BsSql2SimpleDtoExcept other = (BsSql2SimpleDtoExcept)obj;
    ...
    @Override
    public Sql2SimpleDtoExcept clone() {
        return (Sql2SimpleDtoExcept)super.clone();
    }
