...
/**
 * The entity of WHITE_BASE_ONE12_AMPHI as TABLE. <br>
 * <pre>
 * [primary-key]
 *     AMPHI_ID
 *
...
public abstract class BsWhiteBaseOne12Amphi extends AbstractEntity implements DomainEntity {
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsWhiteBaseOne12Amphi) {
            BsWhiteBaseOne12Amphi other = (BsWhiteBaseOne12Amphi)obj;
            if (!xSV(_amphiId, other._amphiId)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected String doBuildColumnString(String dm) {
        StringBuilder sb = new StringBuilder();
        sb.append(dm).append(xfND(_amphiId));
        sb.append(dm).append(xfND(_amphiName));
    ...
    @Override
    public WhiteBaseOne12Amphi clone() {
        return (WhiteBaseOne12Amphi)super.clone();
    }
     ...
     * @return The value of the column 'AMPHI_ID'. (basically NotNull if selected: for the constraint)
     */
    public Integer getAmphiId() {
        checkSpecifiedProperty("amphiId");
        return _amphiId;
    }

    /**
     * [set] AMPHI_ID: {PK, NotNull, INTEGER(10)} <br>
     * @param amphiId The value of the column 'AMPHI_ID'. (basically NotNull if update: for the constraint)
     */
    public void setAmphiId(Integer amphiId) {
        registerModifiedProperty("amphiId");
        _amphiId = amphiId;
    }

    /**
     * [get] AMPHI_NAME: {NotNull, VARCHAR(200)} <br>
     * @return The value of the column 'AMPHI_NAME'. (basically NotNull if selected: for the constraint)
     */
    public String getAmphiName() {
        checkSpecifiedProperty("amphiName");
        return convertEmptyToNull(_amphiName);
    }

    /**
     * [set] AMPHI_NAME: {NotNull, VARCHAR(200)} <br>
     * @param amphiName The value of the column 'AMPHI_NAME'. (basically NotNull if update: for the constraint)
     */
    public void setAmphiName(String amphiName) {
        registerModifiedProperty("amphiName");
        _amphiName = amphiName;
    }
