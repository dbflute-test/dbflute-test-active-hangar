...
public abstract class BsWhiteOnParadeNullableToMany extends AbstractEntity implements DomainEntity {
    ...
    /**
     * [get] WHITE_ON_PARADE_REF by NULLABLE_FK_TO_MANY_ID, named 'whiteOnParadeRefList'.
    ...
    /**
     * [set] WHITE_ON_PARADE_REF by NULLABLE_FK_TO_MANY_ID, named 'whiteOnParadeRefList'.
