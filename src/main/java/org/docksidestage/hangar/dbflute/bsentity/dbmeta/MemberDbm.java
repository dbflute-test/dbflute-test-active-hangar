...
public class MemberDbm extends AbstractDBMeta {
    ...
    protected final String _tableAlias = "mysticみすみす";
    public String getTableAlias() { return _tableAlias; }
    protected final String _tableComment = "seasea 眠いときは寝た方が良い。\n会員のプロフィールやアカウントなどの基本情報を保持する。\n基本的に物理削除はなく、退会したらステータスが退会会員になる。\nライフサイクルやカテゴリの違う会員情報は、one-to-oneなどの関連テーブルにて。dfalias:{ mysticみすみす }";
    public String getTableComment() { return _tableComment; }

    // ===================================================================================
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnMemberId = cci("MEMBER_ID", "MEMBER_ID", null, null, Integer.class, "memberId", null, true, true, true, "INTEGER", 10, 0, null, "NEXT VALUE FOR \"PUBLIC\".\"SYSTEM_SEQUENCE_30114F14_855E_4BFA_9DAB_936A75C6BB26\"", false, null, "sea 連番として自動採番される。会員IDだけに限らず採番方法はDBMS次第。\nsea", "memberAddressAsValid,memberServiceWithIfComment,memberSecurityAsOne,memberServiceAsOne,memberWithdrawalAsOne", "memberAddressList,memberFollowingByMyMemberIdList,memberFollowingByYourMemberIdList,memberLoginList,purchaseList", null, false);
    protected final ColumnInfo _columnMemberName = cci("MEMBER_NAME", "MEMBER_NAME", null, "ここねこさん", String.class, "memberName", null, false, false, true, "VARCHAR", 200, 0, null, null, false, null, "seasea 会員のフルネームの名称。\n苗字と名前を分けて管理することが多いが、dfalias:{ ここねこさん } ここでは単純にひとまとめ。\n\naaaa", null, null, null, false);
    ...
    protected final ColumnInfo _columnBirthdate = cci("BIRTHDATE", "BIRTHDATE", null, null, java.time.LocalDate.class, "birthdate", null, false, false, false, "DATE", 10, 0, null, null, false, null, "お腹が空いたら食べた方が良い。\n必須項目ではないので、このデータがない会員もいる。\nsea", null, null, null, false);
    ...
    /**
     * MEMBER_SERVICE by my MEMBER_ID, named 'memberServiceWithIfComment'.
     * @return The information object of foreign property. (NotNull)
     */
