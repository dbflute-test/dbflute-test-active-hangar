...
public class ProductDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnProductId = cci("PRODUCT_ID", "PRODUCT_ID", null, null, Integer.class, "productId", null, true, true, true, "INTEGER", 10, 0, null, "NEXT VALUE FOR \"PUBLIC\".\"SYSTEM_SEQUENCE_21CCA1F7_927A_4AA3_915E_C90FDEAC1146\"", false, null, null, null, "purchaseList,whiteDeprecatedRefList", null, false);
    ...
    protected final ColumnInfo _columnProductCategoryCode = cci("PRODUCT_CATEGORY_CODE", "PRODUCT_CATEGORY_CODE", null, "眠い商品カテゴリーコードどん", String.class, "productCategoryCode", null, false, false, true, "CHAR", 3, 0, null, null, false, null, "眠いのも悪くない。", "productCategory", null, null, false);
    ...
    protected final ColumnInfo _columnRegularPrice = cci("REGULAR_PRICE", "REGULAR_PRICE", null, "眠い定価", Integer.class, "regularPrice", null, false, false, true, "INTEGER", 10, 0, null, null, false, null, "眠いよぅ眠いよぅ。ようよう。\n定価:かかか", null, null, null, false);
    ...
    protected final ColumnInfo _columnUpdateDatetime = cci("UPDATE_DATETIME", "UPDATE_DATETIME", null, "更新日時", java.time.LocalDateTime.class, "updateDatetime", null, false, false, true, "TIMESTAMP", 26, 6, null, null, true, null, "ALL設定を上書きしてみる", null, null, null, false);
