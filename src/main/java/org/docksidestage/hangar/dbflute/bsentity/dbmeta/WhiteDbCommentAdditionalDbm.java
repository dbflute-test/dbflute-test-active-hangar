...
public class WhiteDbCommentAdditionalDbm extends AbstractDBMeta {
    ...
    protected final ColumnInfo _columnDbCommentCount = cci("DB_COMMENT_COUNT", "DB_COMMENT_COUNT", null, "DB:コメント:件数", Integer.class, "dbCommentCount", null, false, false, true, "INTEGER", 10, 0, null, null, false, null, ": いきなりコロンで始まったり : 途中でコロンが入ったり", null, null, null, false);
