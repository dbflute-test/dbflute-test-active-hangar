...
public abstract class BsWhiteDbCommentBhv extends AbstractBehaviorWritable<WhiteDbComment, WhiteDbCommentCB> {
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public OptionalEntity<WhiteDbComment> selectByPK(Long dbCommentId) {
        return facadeSelectByPK(dbCommentId);
    }

    protected OptionalEntity<WhiteDbComment> facadeSelectByPK(Long dbCommentId) {
        return doSelectOptionalByPK(dbCommentId, typeOfSelectedEntity());
    }

    protected <ENTITY extends WhiteDbComment> ENTITY doSelectByPK(Long dbCommentId, Class<? extends ENTITY> tp) {
        return doSelectEntity(xprepareCBAsPK(dbCommentId), tp);
    }

    protected <ENTITY extends WhiteDbComment> OptionalEntity<ENTITY> doSelectOptionalByPK(Long dbCommentId, Class<? extends ENTITY> tp) {
        return createOptionalEntity(doSelectByPK(dbCommentId, tp), dbCommentId);
    }

    protected WhiteDbCommentCB xprepareCBAsPK(Long dbCommentId) {
     ...
     */
    public List<Long> extractDbCommentIdList(List<WhiteDbComment> whiteDbCommentList)
    { return helpExtractListInternally(whiteDbCommentList, "dbCommentId"); }
