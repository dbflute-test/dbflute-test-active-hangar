...
public abstract class BsWhiteSelfReferenceBhv extends org.docksidestage.hangar.dbflute.nogen.ExtendedAbstractBehaviorWritable<WhiteSelfReference, WhiteSelfReferenceCB> {
     ...
     * @param selfReferenceId : PK, NotNull, INTEGER(10). (NotNull)
     * @return The optional entity selected by the PK. (NotNull: if no data, empty entity)
     * @throws EntityAlreadyDeletedException When get(), alwaysPresent() of return value is called and the value is null, which means entity has already been deleted (not found).
     * @throws EntityDuplicatedException When the entity has been duplicated.
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public OptionalEntity<WhiteSelfReference> selectByPK(Integer selfReferenceId) {
        return facadeSelectByPK(selfReferenceId);
    }

    protected OptionalEntity<WhiteSelfReference> facadeSelectByPK(Integer selfReferenceId) {
        return doSelectOptionalByPK(selfReferenceId, typeOfSelectedEntity());
    }

    protected <ENTITY extends WhiteSelfReference> ENTITY doSelectByPK(Integer selfReferenceId, Class<? extends ENTITY> tp) {
        return doSelectEntity(xprepareCBAsPK(selfReferenceId), tp);
    }

    protected <ENTITY extends WhiteSelfReference> OptionalEntity<ENTITY> doSelectOptionalByPK(Integer selfReferenceId, Class<? extends ENTITY> tp) {
        return createOptionalEntity(doSelectByPK(selfReferenceId, tp), selfReferenceId);
    }

    protected WhiteSelfReferenceCB xprepareCBAsPK(Integer selfReferenceId) {
     ...
     */
    public NestedReferrerListGateway<WhiteSelfReference> loadWhiteSelfReferenceSelf(List<WhiteSelfReference> whiteSelfReferenceList, ReferrerConditionSetupper<WhiteSelfReferenceCB> refCBLambda) {
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<WhiteSelfReference> loadWhiteSelfReferenceSelf(WhiteSelfReference whiteSelfReference, ReferrerConditionSetupper<WhiteSelfReferenceCB> refCBLambda) {
     ...
     */
    public List<Integer> extractSelfReferenceIdList(List<WhiteSelfReference> whiteSelfReferenceList)
